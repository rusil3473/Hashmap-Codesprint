...
const models = [
  { id: 'gpt-4o', name: 'GPT-5' },
  { id: 'claude-3-5-sonnet', name: 'Claude 4 Sonnet' },
  { id: 'gemini-1.5-pro', name: 'Gemini 2.5 Pro' },
  { id: 'llama-3.1-70b', name: 'Llama 3.3 70B' },
];
    ...
    setMessages([
      {
        ...
        timestamp: new Date(),
        sources: [
          { title: "User Information", url: "#" },
          { title: "Hospitals Documentation", url: "#" }
        ]
      }
    ]);
    setInputValue('');
      ...
      <div className="border-t p-4">
        <PromptInput onSubmit={handleSubmit}>
          <PromptInputTextarea
            ...
            placeholder="Ask me anything about medical or yourself!"
            disabled={isTyping}
          />
          <PromptInputToolbar>
            <PromptInputTools>
